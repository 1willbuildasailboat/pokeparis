...
const struct SpeciesInfo gSpeciesInfoGen1[] =
{
    ...
    [SPECIES_BULBASAUR] =
    {
        ...
        .description = COMPOUND_STRING(
            "Au début de sa vie, \n"
            "il se nourrit des nutriments accumulés dans la graine sur son dos. \n"
            "Cela lui permet de grandir. "),
        .pokemonScale = 356,
        .pokemonOffset = 17,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_IVYSAUR] =
    {
        ...
        .weight = 130,
        .description = COMPOUND_STRING(
            "Plus il s’expose au soleil, \n"
            "plus il emmagasine d’énergie,\n"
            "ce qui permet au bourgeon sur son dos\n"
            "de se développer."),
        .pokemonScale = 335,
        .pokemonOffset = 13,
        .trainerScale = 256,
